...
//                 Increase
//               </button>
//               <button onClick={() => setCount(0)} className="btn btn-danger m-2">
//                 Reset
//               </button>
...
//                   <button type="submit" className="btn btn-success w-75 m-2">
//                     Submit
//                   </button>
//                 </div>
//               </form>
...
//             ></div>
//             <button onClick={handleBoldClick} className="btn btn-primary p-2 m-2">
//               Bold
//             </button>
//             <button onClick={handleItalicClick} className="btn btn-primary p-2 m-2">
//               Italic
//             </button>
//             <button onClick={handleUnderlineClick} className="btn btn-primary p-2 m-2">
//               Underline
//             </button>
//             <button onClick={handleListClick} className="btn btn-primary p-2 m-2">
//               Add List
//             </button>
//             <button onClick={handleReverse} className="btn btn-primary p-2 m-2">
//               Reverse Content
//             </button>
//             <button onClick={handleSaveClick} className="btn btn-success p-2 m-2">
//               Save
//             </button>
//           </div>
//         </div>
